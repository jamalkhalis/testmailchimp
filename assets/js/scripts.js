...
const formActionURL = `https://gmail.us22.list-manage.com/subscribe/post?u=59d71c0674faf9a48643d9394&amp;id=2a1ab82bf9&amp;f_id=00a3d4e1f0`; 
                ...
                window[callback] = function(data) {
                    ...
                    if (data.result === "success") {
                        ...
                        responseDiv.innerHTML = `
                            <div class="alert bg-success bg-opacity-10 d-flex p-3 mt-2" role="alert">
                        ...
                        responseDiv.innerHTML = `
                            <div class="alert bg-warning bg-opacity-10 d-flex p-3 mt-2" role="alert">
